 ...
 *
 * Visual sibling of <BoostCard> and <NoteCard>, but deliberately NOT in their
 * list: receipts get their own section, because a receipt and a boost note are
 * different evidence and one heading over both made the page look like it
 * answered "what was I paid", which it does not. It also cannot BE <BoostCard>:
 ...
 *
 * The `zap` stamp beside the amount is load-bearing even though the section
 * heading now says the same thing. A receipt and a kind:1 boostagram look
 * identical once rendered, but they carry different evidence — the receipt is
 * the settled payment, the note is the sender's claim about one — and a card
 * gets screenshotted out of its section, where the heading does not travel
 * with it.
 *
